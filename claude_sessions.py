    ...
    <div class="card">
      ...
      <div class="row2">
        <div><div class="lbl">Clawdmeter-Firmware, Fork</div>
          <div class="desc">Hermanns Firmware sucht sich die Animation nach Verbrauchsgeschwindigkeit aus. Damit das Gerät zeigt, was Claude gerade macht, muss dieser Fork darauf laufen.</div></div>
        <button class="btn" onclick="api.open_url('https://github.com/JayceTheGaymer/Clawdmeter')">Öffnen</button>
      </div>
    </div>
  `;
